	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form" action="biodata.php">
					...
					<div class="wrap-input100 rs1-wrap-input100 validate-input m-b-1" data-validate="Type user name">
						...
						<input id="first-name" class="input100" type="text" name="username" value="alioke@gmail.com">
					...
					<div class="row" style="width: 100%">
						<div class="col-6">
							...
							<input class="input100" type="text" name="first-name" value="Mohammad">
							<span class="focus-input100"></span>
							</div>
						</div>
						<div class="col-6">
							...
							<div class="wrap-input100 rs2-wrap-input100 validate-input m-b-1">
							<input class="input100" type="text" name="last-name" value="Ali">
							<span class="focus-input100"></span>
							</div>
						</div>
					</div>
					...
					<div class="wrap-input100 rs2-wrap-input100 validate-input m-b-1">
						<input class="input100" type="text" name="noHP" value="08777120318">
						<span class="focus-input100"></span>
					</div>

					<span class="span-label">Tanggal Lahir</span>
					<div class="wrap-input100 rs2-wrap-input100 validate-input m-b-1">
						<input class="form-control" type="date" value="1995-05-30" id="example-date-input">
					</div>
					...
					<div class="container-login100-form-btn">
						<button class="login100-form-btn" onclick="alert('Data berhasil diubah'">
							Simpan
						</button>
					</div>
				</form>
